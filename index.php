...
<head>
    ...
    <title>Quotations project</title>
    ...
    <div class="containter-fluid">
        ...
        <nav class="navbar navbar-expand-sm bg-primary navbar-dark justify-content-center">
            ...
            <ul class="navbar-nav nav-justified">
                ...
                <li class="nav-item pl-2 pr-2"> <a class="nav-link" href="zdravlje.php"> Health </a> </li>   
                <li class="nav-item pl-2 pr-2"> <a class="nav-link" href="motivacija.php"> Motivation </a> </li>
    ...
    <div class="containter-fluid">
        ...
        <section class="text-center">
            ...
            <?php 
                ...
                $citatiLjubav = file('citati/ljubav.txt');
                $citatiMotivacija = file('citati/motivacija.txt');
                $citatiPosao = file('citati/posao.txt');
                $citatiZdravlje = file('citati/zdravlje.txt');


                $sveZajedno = array_merge($citatiLjubav, $citatiMotivacija, $citatiPosao, $citatiZdravlje);
                $nasumicno = rand(0, count($sveZajedno) - 1);

                if($nasumicno % 2 == 0)
                {
                    $citat = $sveZajedno[$nasumicno];
                    $autor = $sveZajedno[$nasumicno + 1];
                }
                else //($nasumicno % 2 == 1) ako je citat neparan, a autor paran
                {
                    $citat = $sveZajedno[$nasumicno - 1];
                    $autor = $sveZajedno[$nasumicno];
                }
