    ...
    <div class="containter-fluid">
        ...
        <section class="text-center">
            ...
            <?php 
                ...
                $nasumicno = rand(0, count($citatiZdravlje) - 1);
                ...
                if($nasumicno % 2 == 0)
                {
                    $citat = $citatiZdravlje[$nasumicno];
                    $autor = $citatiZdravlje[$nasumicno + 1];
                }
                else //($nasumicno % 2 == 1) - ako je citat neparan, a autor paran
                {
                    $citat = $citatiZdravlje[$nasumicno - 1];
                    $autor = $citatiZdravlje[$nasumicno];
                }
