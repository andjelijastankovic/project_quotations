    ...
    <div class="container-fluid">
        ...
        <section class="text-center">
            ...
            <?php 
                ...
                $nasumicno = rand(0, count($citatiLjubav) - 1);
                ...
                if($nasumicno % 2 == 0)
                {
                    $citat = $citatiLjubav[$nasumicno];
                    $autor = $citatiLjubav[$nasumicno + 1];
                }
                else //($nasumicno % 2 == 1) ako je citat neparan, a autor paran
                {
                    $citat = $citatiLjubav[$nasumicno - 1];
                    $autor = $citatiLjubav[$nasumicno];
                }
